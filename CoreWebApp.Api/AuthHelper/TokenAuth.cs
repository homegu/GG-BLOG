...
namespace CoreWebApp.Api.AuthHelper
{
    public class TokenAuth
    {
        ...
        public Task Invoke(HttpContext httpContext)
        {
            ...
            if (!headers.ContainsKey("Authorization"))
            {
                ...
                //return httpContext.Response.WriteAsync("你无权访问。");
            }
            ...
            try
            {
                ...
                UserBaseViewModel tm = ((UserBaseViewModel)MemoryCacheHelper.Get(jwtStr));
                //提取tokenModel中的Sub属性进行authorize认证
                List<Claim> lc = new List<Claim>();
                Claim c = new Claim(tm.UserName + "Name", tm.UserName);
                lc.Add(c);
